...
trait IcebergCompatV2EnableUniformByAlterTableSuiteBase extends QueryTest {
  ...
  /** The number of expected overlapped parquet files */
  protected val overlappedParquetFilesNum: Int = -1

  /** The number of expected added parquet files */
  protected val addedParquetFilesNum: Int = -1
  ...
  protected def alterTableToEnableIcebergCompatV2BaseCase(id: String, loc: String): Unit = {
    ...
    assertParquetFootersProperties(
      ...
      expectedNumOfOverlappedParquetFiles = overlappedParquetFilesNum,
      expectedNumOfAddedParquetFiles = addedParquetFilesNum,
