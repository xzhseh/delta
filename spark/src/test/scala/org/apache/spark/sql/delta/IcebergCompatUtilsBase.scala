...
trait IcebergCompatUtilsBase extends QueryTest {
  ...
  protected val confStr: String =
    "spark.databricks.delta.properties.defaults.universalFormat.enabledFormats"

  protected val compatConfStr: String =
    s"spark.databricks.delta.properties.defaults.enableIcebergCompatV$compatVersion"
